::  beak-kernel.hoon: heavy tentacle — full settlement, no STARK
::
...
::  The Rust hull handles transaction building natively.  Beak stays
...
::
::  Compiled: hoonc --new protocol/lib/beak-kernel.hoon hoon/
::  Output:   assets/beak.jam
::
/-  *vesl
/+  *vesl-logic
/=  *  /common/wrapper
