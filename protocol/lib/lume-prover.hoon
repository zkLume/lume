::  lib/lume-prover.hoon: STARK proof generation for arbitrary Nock computation
::
::  Forked from nock-prover.hoon to bypass puzzle-nock.  The standard
::  prover is PoW-specific: it derives [subject formula] from
::  puzzle-nock(header, nonce, pow-len).  Lume needs to prove
...
++  prove-computation
  ...
  ::
  ::  Zero puzzle commitment — no PoW.  Lume verifier identifies
