::  lib/lume-verifier.hoon: STARK proof verification for Lume computations
::
...
::  Level 2 (verify): full STARK math via lume-stark-verifier fork.
::
/=  *  /common/zeke
/=  lume-stark-verifier  /lib/lume-stark-verifier
/#  softed-constraints
::
|%
::
...
::  into the lume-stark-verifier door via +<+< axis.
::
++  verifier
  =|  in=stark-input
  =/  sc=stark-config
